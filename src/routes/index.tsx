            ...
            <div className="relative overflow-hidden">
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
                    ...
                    <p className="text-xl md:text-2xl leading-tight text-white/80 mb-8 max-w-3xl mx-auto">
                        The complete open-source platform for
                        astro-photographers to manage projects, track imaging
                        sessions, organize equipment and know your results in
                        numbers with precision and ease.
                    </p>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-white/80 max-w-3xl mx-auto leading-tight">
                        From planning sessions to analyzing results, manage
                        every aspect of your celestial photography workflow.
                    </p>
                </div>
